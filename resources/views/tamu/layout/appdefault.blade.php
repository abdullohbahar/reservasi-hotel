...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page"
                            href="{{ url('dashboard/tamudefault') }}">Home</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('pesankamar/tamudefault') }}">Pesan Kamar</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('pembayaran/tamudefault') }}">Pembayaran</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header class="py-5 bg-warning">
        <div class="text-center my-5">
            ...
            <p class=" mb-0">Default (nama)</p>
            <div class="mt-4">

                <a href="{{ url('daftar/user') }}" class="btn btn-primary" type="submit">Daftar</a>
                <a href="{{ url('login/user') }}" class="btn btn-success" type="submit">Login</a>
            </div>
        </div>
